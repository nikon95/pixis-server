...
do {
	...
	$echoString .= '<td align="center"><a href="categories.html"';
...
if($element == "2"){
	$echoString .= '<br/><div>Προσθήκη Νέου<a href="categories.html"><img src="images/add.jpg" height="15" width="15"></a></div>';
}
if($element == "3"){
	$echoString .= '<br/><div>Προσθήκη Νέου<a href="services.html"><img src="images/add.jpg" height="15" width="15"></a></div>';
}
echo $echoString;
?>